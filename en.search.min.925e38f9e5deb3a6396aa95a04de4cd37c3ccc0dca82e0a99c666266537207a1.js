...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/learn-docs/flexsearch.min.js');loadScript('/learn-docs/en.search-data.min.2d38810080d69a22cb7792feb9c4fbcd27eb0594c070e87c14f3ba910622fa00.js',function(){input.required=false;search();});}
