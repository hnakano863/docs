...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/learn-docs/flexsearch.min.js');loadScript('/learn-docs/en.search-data.min.6170dcccdf0cb636ff6e4b62eccf69a6af1c866a94926f46f718cf6e3b1c4503.js',function(){input.required=false;search();});}
