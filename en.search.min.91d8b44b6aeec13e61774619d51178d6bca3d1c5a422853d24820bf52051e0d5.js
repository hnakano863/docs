...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/learn-docs/flexsearch.min.js');loadScript('/learn-docs/en.search-data.min.32cf4ba8d5ec32decc3fad10e06d9e5d0e329e243c2d59d49a4b7dd0d2c3cd22.js',function(){input.required=false;search();});}
