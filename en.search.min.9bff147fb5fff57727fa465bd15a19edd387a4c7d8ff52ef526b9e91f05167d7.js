...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/learn-docs/flexsearch.min.js');loadScript('/learn-docs/en.search-data.min.b176ef42b68a3b5d8e2d15431a3c39761e5a739a1a90a5cb4b14bac01597845e.js',function(){input.required=false;search();});}
